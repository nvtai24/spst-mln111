...
function MenuScreen({ onStart }) {
  ...
  const { playBackgroundMusic, playMenuSound } = useSoundContext();

  useEffect(() => {
    // Bắt đầu phát nhạc nền khi vào menu
    playBackgroundMusic();
  }, [playBackgroundMusic]);
      ...
      return (
        <div className="menu-content">
          ...
          <div className="menu-text">
            ...
            <p>
              Trong trò chơi này, bạn sẽ trải qua các tình huống mô phỏng sự
              phân hóa xã hội và đấu tranh giai cấp.
            </p>
            <ul className="menu-list">
              <li>Đưa ra các quyết định để sinh tồn và phát triển.</li>
              <li>Quan sát sự thay đổi của các chỉ số xã hội.</li>
              <li>
                Khám phá các kết thúc khác nhau dựa trên lựa chọn của bạn.
              </li>
            </ul>
          </div>
          <button className="menu-btn" onClick={() => handleMenuClick("main")}>
            Quay lại
          </button>
        </div>
      );
    ...
    return (
      <>
        ...
        <button
          ...
          onClick={() => handleMenuClick(onStart)}
        >
          Bắt đầu trò chơi
        </button>
        ...
        <button className="menu-btn" onClick={() => handleMenuClick("intro")}>
          Giới thiệu
        </button>
      </>
    );
  ...
  return (
    <div className="menu-screen">
      <div className="menu-card">{renderContent()}</div>
    </div>
  );
}
